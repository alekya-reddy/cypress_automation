...
//This tc covers follwing scenarios for redirect rules
//add, delete, edit functionality for admin and custom roles
//add, delete, edit functionality for view only users
//redirect test for campaign tools and vex
...
const role2 = {
    roleName: "Redirect Role",
    organizationSettingsCRUD: false,
    organizationSettingsView: true
}
...
describe("Redirect should appear as a new tab within organization settings", () => {
    ...
    it("Before redirect rule added -- verify that editing target slug and refresh on landing page will give 404", () => {
        authoring.common.login()
    ...
    it("After redirect rule added -- verify that editing target slug and refresh on landing page will redirect to edited slug", () => {
        authoring.common.login()
        authoring.settings.deleteRedirectRule(target.incomingPath)
    ...
    it("Before redirect rule added -- verify that editing explore slug and refresh on landing page will give 404", () => {
        authoring.common.login()
    ...
    it("After redirect rule added -- verify that editing explore slug and refresh on landing page will redirect to edited slug", () => {
        authoring.common.login()
        authoring.settings.deleteRedirectRule(explore.incomingPath)
        cy.contains('span', "+ Add Redirect Rule").should("exist").click()
    ...
    it("Before redirect rule added -- verify that editing microsite slug and refresh on landing page will give 404", () => {
        authoring.common.login()
    ...
    it("After redirect rule added -- verify that editing microsite slug and refresh on landing page will redirect to edited slug", () => {
        authoring.common.login()
        authoring.settings.deleteRedirectRule(microsite.incomingPath)
        cy.contains('span', "+ Add Redirect Rule").should("exist").click()
    ...
    it("Before redirect rule added -- verify that editing vex slug and refresh on landing page will give 404", () => {
        authoring.common.login()
    ...
    it("After redirect rule added -- verify that editing vex slug and refresh on landing page will redirect to edited slug", () => {
        authoring.common.login()
        authoring.settings.deleteRedirectRule(vex.incomingPath)
        cy.contains('span', "+ Add Redirect Rule").should("exist").click()
