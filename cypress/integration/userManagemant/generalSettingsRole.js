...
describe('General Settings User Role', function() {
    it(user.roleDescription, function(){
        ...
        if (Cypress.env('TEST_ENV') !== 'prod') {
            ...
            cy.contains(authoring.common.pageTitleLocator, authoring.website.pageTitle).should("not.exist")
            cy.contains("div", "You don't have permission to view this page.")
            ...
            cy.contains("div", "You don't have permission to view this page.").should("not.exist")
            // add new Topic
            authoring.configurations.addTopicTag("1 General Settings Permissions")
            authoring.configurations.deleteTopicTag("1 General Settings Permissions")
            ...
            // TEST View permission for Content Tags
            authoring.common.logout()
            authoring.common.login()
            cy.visit(authoring.userManagement.userRoles.pageURL)
            ...
            cy.contains(authoring.common.pageTitleLocator, authoring.configurations.pageTitles.contentTags).should("exist")
            cy.get(authoring.common.pageTitleBar).within(() => {
                cy.get("span[aria-label='setting']").should("not.exist")
            })
            cy.contains("div", "You don't have permission to view this page.").should("not.exist")
            cy.contains("button", "Add Topic").should("not.exist")
