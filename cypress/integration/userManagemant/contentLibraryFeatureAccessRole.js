...
const user = 
    {
        role: 'qa-multiuser',
        roleDescription: "User should only have access to Content Library Feature",
        userName: constants.orgs[authoring.common.org].multiUser,
        password: constants.orgs[authoring.common.org].multiUserPassword
    }

const role = {
    roleName: "Content Library Feature Access Role.Js",
    contentLibraryFeatureAccessCRUD: true
}
...
describe('Content Library Feature Access User Role', function() {
    it(user.roleDescription, function(){
        ...
        cy.contains("div", "You don't have permission to view this page.", {timeout: 20000})
