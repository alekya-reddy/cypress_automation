...
describe("VEX - Added By and Search filter", ()=>{
    it("Added By and Search filters should work", ()=>{
        ...
        cy.get(authoring.vex.searchButton).click().type(event.name)
        ...
        cy.get(authoring.vex.searchButton).click().type(event1.name)
        cy.contains(event1.name).should('exist')
        cy.get(authoring.vex.clearSearch).click()
        
        cy.get(authoring.vex.searchButton).click().type(noevent)
