...
const user = 
    {
        role: 'qa-multiuser',
        roleDescription: "User should only have access to Organization Settings",
...
describe('Organization Settings User Role', function() {
    it(user.roleDescription, function(){
        ...
        cy.contains(authoring.common.pageTitleLocator, authoring.settings.clientHQ.pageTitle).should("exist")
        cy.contains("div", "You don't have permission to view this page.")
